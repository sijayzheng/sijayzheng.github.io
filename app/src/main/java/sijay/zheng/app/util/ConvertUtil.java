...
import cn.zheng.sijay.j.core.enums.CaseEnum;
...
public class ConvertUtil {
    ...
    private static String upperCamelCase(String name) {
        ...
        return Arrays.stream(name.split(CommConstant.UNDERLINE))
                     .map(e -> {
    ...
    private static String snakeCase(String name, boolean upperCase) {
        ...
        return upperCase ? stringBuffer.toString()
                                       .toUpperCase(Locale.ROOT) : stringBuffer.toString()
