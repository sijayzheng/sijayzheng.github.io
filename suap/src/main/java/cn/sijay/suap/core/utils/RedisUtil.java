...
public class RedisUtil {
    ...
    public static <T> void setCacheObject(final String key, final T value, long millis) {
        setCacheObject(key, value, Duration.ofMillis(millis));
    }
