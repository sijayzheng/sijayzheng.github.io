...
import cn.sijay.suap.core.enums.CaseEnum;
...
public class ConvertUtil {
    ...
    private static String upperCamelCase(String name) {
        name = name.replace(Constants.SPACE, Constants.UNDERLINE);
        return Arrays.stream(name.split(Constants.UNDERLINE)).map(e -> {
