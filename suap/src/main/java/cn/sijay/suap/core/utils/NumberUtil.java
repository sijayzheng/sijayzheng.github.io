...
public class NumberUtil extends NumberUtils {
    ...
    public static void main(String[] args) {
        System.out.println(numberToChinese(2341839492L));
    }
    ...
    public static String numberToChinese(String number) {
        ...
        for (int i = 0; i < result.size(); i++) {
            if (UNIT_HIGH.contains(result.get(i)) && NumberEnum.ZERO.getZhValue()
                                                                    .equals(result.get(i + 1))) {
                result.set(i, "");
            }
        }
        Collections.reverse(result);
        return String.join("", result)
                     .replaceAll("零+", NumberEnum.ZERO.getZhValue());
    }
    ...
    public static void main(String[] args) {
        System.out.println(numberToChinese(String.valueOf(2341839492L)));
    }
