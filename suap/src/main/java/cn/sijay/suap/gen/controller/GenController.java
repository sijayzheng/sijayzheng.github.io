...
//        return success(genService.getById(id));
//    }
//
//    /**
//     * 分页查询
...
//        return toPageResult(genService.page(genTable, pageQuery));
//    }
//
//    /**
//     * 删除
...
//        return toBoolean(genService.remove(ids), OperateType.REMOVE);
//    }
//
//    /**
//     * 获取所有要添加的表信息
...
//        return success(genService.listAllTable());
//    }
//}
