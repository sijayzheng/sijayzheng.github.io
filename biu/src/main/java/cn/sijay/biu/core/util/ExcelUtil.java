...
import cn.sijay.biu.core.convert.ExcelBigNumberConvert;
...
import cn.sijay.biu.core.handler.ExcelDownHandler;
import cn.sijay.biu.core.listener.DefaultExcelListener;
import cn.sijay.biu.core.listener.ExcelListener;
...
public class ExcelUtil {
    ...
    public static <T> void exportExcel(List<T> list, String sheetName, Class<T> clazz, HttpServletResponse response) {
        try {
            ...
            throw new UtilException("导出Excel异常");
        }
    }
    ...
    private static void resetResponse(String sheetName, HttpServletResponse response) throws UnsupportedEncodingException {
        ResponseUtil.setResponseHeader(response, sheetName + "_" + UuidUtil.getSimpleUuid() + ".xlsx");
    ...
    public static String convertByExp(String propertyValue, String converterExp, String separator) {
        ...
        String[] convertSource = converterExp.split(SymbolConstants.COMMA);
    ...
    public static String encodingFilename(String filename) {
        return UuidUtil.getSimpleUuid() + "_" + filename + ".xlsx";
    }
