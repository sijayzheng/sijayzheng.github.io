package cn.sijay.biu.core.manager;

import cn.sijay.biu.core.annotation.EncryptField;
import cn.sijay.biu.core.encryptor.IEncryptor;
...
//        return encryptor;
    ...
    private void scanEncryptClasses(String typeAliasesPackage) {
        ...
        String[] packagePatternArray = StringUtil.split(typeAliasesPackage, ConfigurableApplicationContext.CONFIG_LOCATION_DELIMITERS);
