...
;(function ($) {
        ...
        for (var j = 0; j < _6f.length; j++) {
          ...
          if (col.checkbox) {
            ...
            if (col.field) {
              ...
              if (col.width) {
                var _74 = $.parser.parseValue(
                  'width',
                  col.width,
                  dc.view,
                  _5c.scrollbarSize + (_5c.rownumbers ? _5c.rownumberWidth : 0)
                )
                col.deltaWidth = _6b
  ...
  function _91(e) {
    ...
    if (_94.length) {
      ...
      var _95 =
        _93.resizeHandle == 'right'
          ? e.pageX > p2
          : _93.resizeHandle == 'left'
          ? e.pageX < p1
        ...
        if (String(col.width || '').indexOf('%') >= 0) {
          var _e2 =
            $.parser.parseValue(
              ...
              col.width,
              dc.view,
              _d3.scrollbarSize + (_d3.rownumbers ? _d3.rownumberWidth : 0)
            ) - col.deltaWidth
          if (_e2 > 0) {
            col.boxWidth = _e2
            _df = true
    ...
    function _1a(_eb) {
      ...
      function _ee(_ef) {
        ...
        if (_ef == 'header') {
          ...
          _e8.finder
            .getTr(_e5, 0, _ef)
            .find('td[field="' + _eb + '"] div.datagrid-cell')
            .each(function () {
              var w = _f1($(this))
              if (_f0 < w) {
                _f0 = w
      ...
      if (col && col.editor) {
        ...
        if (_177) {
          ...
          $.data(cell[0], 'datagrid.editor', {
            actions: _177,
            target: _177.init(cell.find('td'), $.extend({ height: opts.editorHeight }, _176)),
            field: _174,
            type: _175,
            oldHtml: _178,
          })
  ...
  $.fn.datagrid.methods = {
    options: function (jq) {
      ...
      var opts = $.extend(_1e0, {
        width: _1e1.width,
        height: _1e1.height,
        closed: _1e1.closed,
        collapsed: _1e1.collapsed,
        minimized: _1e1.minimized,
        maximized: _1e1.maximized,
      })
      return opts
    },
  ...
  $.fn.datagrid.parseOptions = function (_20d) {
    ...
    return $.extend(
      {},
      $.fn.panel.parseOptions(_20d),
      $.parser.parseOptions(_20d, [
        'url',
        'toolbar',
        'idField',
        'sortName',
  ...
  var _210 = {
    render: function (_211, _212, _213) {
  ...
  $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
    ...
    rownumberWidth: 30,
    editorHeight: 31,
    headerEvents: { mouseover: _86(true), mouseout: _86(false), click: _8a, dblclick: _91, contextmenu: _97 },
    rowEvents: { mouseover: _9a(true), mouseout: _9a(false), click: _a2, dblclick: _ad, contextmenu: _b2 },
    rowStyler: function (_257, _258) {},
    ...
    editors: _1c7,
    finder: {
      getTr: function (_25c, _25d, type, _25e) {
        type = type || 'body'
        _25e = _25e || 0
