...
item.domId="_easyui_tree_"+item.id.replace(new RegExp("'","gm"),"");
cc.push("<li>");
...
cc.push("<span class=\"tree-subtext\">"+(item.subtext?item.subtext:"")+"</span>");
cc.push("</div>");
if(item.children&&item.children.length){
...
$(this).tooltip("tip").css({borderColor:"#FF9F85"});
},onHide:function(){
$(this).tooltip("destroy");
