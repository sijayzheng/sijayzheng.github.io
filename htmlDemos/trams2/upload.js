...
layui.define('layer', function(exports) {
  ...
  // 字符常量
  var MOD_NAME = 'upload'; var ELEM = '.layui-upload'; var THIS = 'layui-this'; var SHOW = 'layui-show'; var HIDE = 'layui-hide'; var DISABLED = 'layui-disabled'

  var ELEM_FILE = 'layui-upload-file'; var ELEM_FORM = 'layui-upload-form'; var ELEM_IFRAME = 'layui-upload-iframe'; var ELEM_CHOOSE = 'layui-upload-choose'; var ELEM_DRAG = 'layui-upload-drag'
  ...
  Class.prototype.upload = function(files, type) {
    ...
    var ajaxSend = function() {
      var successful = 0; var aborted = 0
    ...
    var iframeSend = function() {
      ...
      Class.timer = setInterval(function() {
        var res; var iframeBody = iframe.contents().find('body')
        try {
          res = iframeBody.text()
        } catch (e) {
  ...
  Class.prototype.events = function() {
    ...
    options.elem.off('upload.start').on('upload.start', function() {
      var othis = $(this); var data = othis.attr('lay-data')
    ...
    if (!(device.ie && device.ie < 10)) {
      options.elem.off('upload.over').on('upload.over', function() {
        ...
        .off('upload.drop').on('upload.drop', function(e, param) {
          var othis = $(this); var files = param.originalEvent.dataTransfer.files || []
