...
function(JTopo) {
    ...
    function toJson(a) {
        ...
        c = "text,elementType,x,y,width,height,visible,alpha,rotate,scaleX,scaleY,fillColor,shadow,transformAble,zIndex,dragable,selected,showSelected,font,fontColor,textPosition,textOffsetX,textOffsetY,nodeid,subtext,linetype,nodeicon".split(","),
        d = "{";
        d += "frames:" + a.frames,
        d += ", scenes:[";
    ...
    function b(c) {
        ...
        this.paint = function(a) {
            if (this.image) {
                ...
                null != this.image.alarm && null != this.alarmColor ?   a.drawImage(this.image, -this.width / 2, -this.height / 2, this.width, this.height):a.drawImage(this.image.alarm, -this.width / 2, -this.height / 2, this.width, this.height),
                a.globalAlpha = b
            } else a.beginPath(),
            a.fillStyle = "rgba(" + this.fillColor + "," + this.alpha + ")",
        ...
        this.paintAlarmText = function(a) {
            if (null != this.alarm && "" != this.alarm) {
                ...
                var d = a.measureText(this.alarm).width + 12,
                e = a.measureText("田").width + 12,
                f = this.width / 2 - d / 2,
                g = -this.height / 2 - e - 2;
                ...
                a.fillText(this.alarm, f + 5, g + e - 8),
                a.closePath()
            }
        },
