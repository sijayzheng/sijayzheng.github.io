...
(function ($){
	...
	$.fn.disk = function (id,options){
		...
		$.each(dataObj.disks,function (i,n){
			...
			//"<tr></tr>"
			var tds="<td width='5%' height='28px' align='right'>"+n.name+"</td><td width='25%' style='bgcolor:"+options.itemStyle.bgColor+";'>"+itemDiv+"</td><td width='18%'>"+n.total+"(使用率："+percentage+"%)</td>";
			if(i%2==0){
				trs+="<tr>"+tds;
			}else{
				trs+=tds+"</tr>";
